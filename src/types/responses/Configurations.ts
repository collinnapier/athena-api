...
export type AllMedicationsResponse = {
    /**
...
export type AllAllergiesResponse = {
    /**
...
export type AllOrderTypesResponse = {
    /**
...
export type AllGenderIdentitiesResponse = {
    /**
...
export type AvailableScreeningQuestionairesResponse = {
    /**
