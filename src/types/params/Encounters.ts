 ...
 */
export interface FindEncounterParams {
  /**
   * encounterid
   */
  encounterid: number;
 ...
 */
export interface EncounterOrdersParams {
  /**
   * encounterid
   */
  encounterid: number;
 ...
 */
export interface EncounterOrderParams {
  /**
   * encounterid
   */
  encounterid: number;
 ...
 */
export interface EncounterSummaryParams {
  /**
   * encounterid
   */
  encounterid: number;
 ...
 */
export interface CreateEncounterOrderLabParams {
  /**
   * encounterid
   */
  encounterid: number;
 ...
 */
export interface CreateEncounterDiagnosesParams {
  /**
   * encounterid
   */
  encounterid: number;
 ...
 */
export interface EncounterScreeningQuestionnairesParams {
  /**
   * encounterid
   */
  encounterid: number;
 ...
 * Endpoint: /v1/{practiceid}/chart/encounter/{encounterid}/questionnairescreeners
 */
export interface ActivateScreeningQuestionnaireParams {
  /**
   * encounterid
   */
  encounterid: number;
 ...
 */
export interface UpdateScreeningQuestionnaireScoreOnlyParams {
  /**
   * encounterid
   */
  encounterid: number;
 ...
 * Endpoint: /v1/{practiceid}/chart/encounter/{encounterid}/questionnairescreeners
 */
export interface UpdateScreeningQuestionnaireParams {
  /**
   * encounterid
   */
  encounterid: number;
