 ...
 */
export type AllFacilitiesParams = {
    /**
 ...
 */
export type AllMedicationsParams = {
    /**
 ...
 */
export type AllAllergiesParams = {
    /**
     * A term to search for. Must be at least 2 characters
     */
    searchvalue: string;
 ...
 */
export type AllInsurancesParams = {
    /**
 ...
 */
export type AllOrderTypesParams = {
    /**
     * A term to search for. Must be at least 2 characters
     */
    searchvalue: string;
 ...
 */
export type AllGenderIdentitiesParams = {
    /**
 ...
 */
export type AvailableScreeningQuestionairesParams = {
    /**
