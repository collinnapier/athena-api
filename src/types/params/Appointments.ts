 ...
 */
export type AllAppointmentTypesParams = {
    /**
 ...
 */
export type FindAppointmentTypeParams = {
    /**
     * appointmenttypeid
     */
 ...
 */
export type OpenAppointmentSlotsParams = {
    /**
 ...
 * Endpoint: /v1/{practiceid}/appointments/open
 */
export type CreateAppointmentSlotParams = {
    /**
 ...
 */
export type AllPatientAppointmentReasonsParams = {
    /**
     * The athenaNet department ID.
     */
    departmentid: number;
 ...
 */
export type BookedAppointmentsParams = {
    /**
 ...
 */
export type MultipledepartmentBookedAppointmentsParams = {
    /**
     * Filter by appointment type ID.
     */
    appointmenttypeid?: number;
 ...
 */
export type AppointmentNotesParams = {
    /**
     * appointmentid
     */
    appointmentid: number;
 ...
 * Endpoint: /v1/{practiceid}/appointments/{appointmentid}/notes
 */
export type CreateAppointmentNoteParams = {
    /**
     * appointmentid
     */
    appointmentid: number;
 ...
 */
export type StartCheckInParams = {
    /**
     * appointmentid
     */
    appointmentid: number;
 ...
 */
export type CancelCheckInParams = {
    /**
     * appointmentid
     */
    appointmentid: number;
 ...
 * Endpoint: /v1/{practiceid}/appointments/{appointmentid}
 */
export type FindAppointmentParams = {
    /**
     * appointmentid
     */
    appointmentid: number;
 ...
 */
export type AppointmentRemindersParams = {
    /**
 ...
 */
export type FindAppointmentReminderParams = {
    /**
 ...
 * Endpoint: /v1/{practiceid}/appointments/appointmentreminders
 */
export type CreateAppointmentReminderParams = {
    /**
     * Content type of the payload
     */
    ContentType: string;
 ...
 * Endpoint: /v1/{practiceid}/appointments/appointmentreminders/{appointmentreminderid}
 */
export type DeleteAppointmentReminderParams = {
    /**
     * appointmentreminderid
     */
    appointmentreminderid: number;
 ...
 */
export type AppointmentInsurancesParams = {
    /**
     * appointmentid
     */
    appointmentid: number;
 ...
 */
export type CreateAppointmentWaitlistParams = {
    /**
     * Content type of the payload
     */
    ContentType: string;
