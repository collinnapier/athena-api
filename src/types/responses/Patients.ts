...
export interface FindPatientResponse {
   ...
   * List of active patient insurance packages. Only shown for a single patient and if SHOWINSURANCE is set.
   */
  insurances: PatientInsurancesResponse[];
  /**
   * Language of the patient, using the ISO 639.2 code. (http://www.loc.gov/standards/iso639-2/php/code_list.php; "T" or terminology code) Special case: use "declined" to indicate that the patient declined to answer.
   */
  language6392code: string;
...
export interface FindBestmatchPatientsResponse {
  /**
   * Patient's address - 1st line
   */
  address1: string;
...
export interface CreatePatientProblemResponse {
  /**
...
export interface FindPatientProblemsResponse {
  /**
...
export interface PatientLabResultDocumentResponse {
  /**
...
export interface UpdatePatientMedicalHistoryResponse {
  /**
...
export interface PatientAnalytesResponse {
  /**
...
export interface CreatePatientDocumentResponse {
  /**
   * The document ID of the created document.
   */
  documentid: string;
}
export interface CreatePatientEncounterDocumentResponse {
  /**
...
export interface SetPatientDefaultPharmacyResponse {
  /**
   * Whether the operation was successful.
   */
  success: boolean;
...
export interface PatientPreferredPharmaciesResponse {
  /**
   * Zip code of the pharmacy
   */
  zip: string;
...
export interface AddPatientPreferredPharmacyResponse {
  /**
   * Whether the operation was successful.
   */
  success: boolean;
...
export interface PatientDefaultLaboratoryResponse {
  /**
   * Zip code of the lab
   */
  zip: string;
...
export interface SetPatientDefaultLaboratoryResponse {
  /**
   * Whether the operation was successful.
   */
  success: boolean;
...
export interface PatientSocialHistoryTemplatesResponse {
  /**
...
export interface SetPatientSocialHistoryTemplatesResponse {
  /**
...
export interface UpdatePatientSocialHistoryResponse {
  /**
   * On failure, the reason for failure
   */
  message: string;
...
export interface PatientSocialHistoryResponse {
  /**
...
export interface AddPatientMedicationResponse {
  /**
   * Whether the operation was successful or not.
   */
  success: boolean;
...
export interface UpdatePatientMedicationsResponse {
  /**
   * Whether the operation was successful.
   */
  success: boolean;
...
export interface UpdatePatientAllergiesResponse {
  /**
...
export interface VerifyPatientPrivacyInformationResponse {
  /**
   * Returns true/false if the operation was successful.
   */
  success: boolean;
...
export interface DeletePatientInsuranceResponse {
  /**
   * If success is false, this contains an error message with more detail.
   */
  message: string;
...
export interface UpdatePatientInsuranceCardImageResponse {
  /**
...
export interface PatientInsurancesResponse {
  /**
   * CASE POLICY FIELD - Fax for the adjuster on this case policy.  Only available for auto insurance or worker's comp case policies.
   */
  adjusterfax: string;
...
export interface UpdatePatientPhotoResponse {
  /**
   * Indicates whether the submission was successful.
   */
  success: boolean;
}
export interface CreatePatientCaseResponse {
  /**
   * Returns true/false if the operation was successful.
   */
  success: boolean;
